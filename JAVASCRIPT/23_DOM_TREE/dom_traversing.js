...
// child Node of Rooot Node ----> with the help of childNodes
// const childOfRootNode = rootNode.childNodes;
// console.log(childOfRootNode); // documentObject
// so. ROot Node ---> ducument object



// childNode of root node -->with help of childNodes
// const childOfRootNodes =rootNode.childNodes;
// console.log(childOfRootNodes);  //NodeList [html]
...
// child nodes pf HTML FETCHING THEM:

const headElelmentNode =htmlchildNodes[0];
const textElementNode = htmlchildNodes[1];
const bodyElementNode = htmlchildNodes[2];
console.log(headElelmentNode);
console.log(textElementNode);
console.log(bodyElementNode);

// To check parent node with parent node
console.log(headElelmentNode.parentNode);
